...
public class ProxyConnection implements Connection {
    ...
    public void close() throws SQLException {
        try {
            CustomDataSourceBasedConnectionPool pool = (CustomDataSourceBasedConnectionPool)SpringAppContext.getApplicationContext().getBean(BEAN_TOKEN_CONNECTION_POOL);
