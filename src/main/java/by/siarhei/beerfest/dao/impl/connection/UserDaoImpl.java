...
public class UserDaoImpl extends DaoManager implements UserDao {
    ...
    public UserDaoImpl(CustomDataSourceBasedConnectionPool connectionPool, EntityBuilder builder) {
    ...
    public User findUserByLogin(String login) throws DaoException {
        User user = getBuilder().buildUser();
    ...
    public List<User> findAll(long offset) throws DaoException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                list.add(builder.buildUser(id,login,eMail,role,status));
            }
        } catch (SQLException e) {
    ...
    public long create(User user) throws DaoException {
        ...
        try {
            connection = getConnection();
            statement = connection.prepareStatement(INSERT_LOGIN_SQL,Statement.RETURN_GENERATED_KEYS);
