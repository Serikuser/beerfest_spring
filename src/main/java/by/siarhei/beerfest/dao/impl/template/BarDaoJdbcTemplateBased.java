...
public class BarDaoJdbcTemplateBased implements BarDao {
    ...
    private BarDaoJdbcTemplateBased(JdbcTemplate template, EntityBuilder builder) {
        ...
        try {
            return template.query(SELECT_ALL_BAR_SQL,
                    (resultSet, rowNumber) -> {
                        ...
                        return builder.buildBar(barId,accountId,name,description,foodId,foodName,beerId,beerName,places);
                    });
        } catch (DataAccessException e) {
