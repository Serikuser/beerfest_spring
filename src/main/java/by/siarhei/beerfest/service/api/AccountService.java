package by.siarhei.beerfest.service.api;
...
public interface AccountService {
     ...
     * @return
     */
    long signupUser(String login, String eMail, String password, RoleType role, StatusType status) throws ServiceException;
