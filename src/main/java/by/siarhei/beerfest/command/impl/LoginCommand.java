...
public class LoginCommand implements ActionCommand {
    ...
    public LoginCommand(AccountService accountService, LanguageService languageService, BarService barService) {
     ...
     * and get session filled by needed values, special feed logic to {@code RoleType} Participant
