...
<div class="sidebar-block_content profile-info">
    <div class="profile-info_item">
        <form action="controller" class="needs-validation" onsubmit="return cryptChange()" novalidate>
            ...
            <button type="submit" class="button_success button_width_100"><fmt:message key="sidebar.participant.books"/></button>
        </form>
    </div>
    <div class="profile-info_item">
        <form action="controller" class="needs-validation" novalidate>
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <input type="hidden" name="command" value="bar"/>
                    </div>
                </div>
            </div>
            <button type="submit" class="button_success button_width_100"><fmt:message key="sidebar.participant.bar"/></button>
        </form>
    </div>
</div>
